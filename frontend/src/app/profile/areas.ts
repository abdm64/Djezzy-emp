...
export const AREAS: Area[] = [
    ...
    imgPath: '../../assets/images/full-stack.png',
...
It is estimated to take 1800hours and it took me all of 2017 working part-time. It gave me experience in a variety of web development tools. From there I wanted to specialise in one javascript framework. After studying React and Vue I decided to focus on Angular.`
    ...
    imgPath: '../../assets/images/prog.png',
    ...
    imgPath: '../../assets/images/tensorflow.png',
